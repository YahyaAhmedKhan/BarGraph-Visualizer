...
public class LocationDeterminer {
     ...
     * <br/>
     * 
     * The first bar is always at (0,0). This simplifes the visualizing where tha
     * bars
    ...
    public static ArrayList<Point> getVerticalPoints(JavaGraphs javaGraph) {
        ...
        double horiWidth = BarWidthDeterminer.getBarWidth(javaGraph);
        // width of bars on Vertical Bar Graph:
        double vertWidth = horiWidth * ((drawWidth - ((javaGraph.getBarCount() + 3) * gap))
                / (double) (drawHeight - ((javaGraph.getBarCount() + 3) * gap)));
